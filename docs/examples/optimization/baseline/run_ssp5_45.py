...
# ------------------------------------
# Fossil kerosene only. SSP5-4.5 represents a fossil-fueled development pathway with
# high demand growth — the loosest carbon budget but the largest traffic volumes.
