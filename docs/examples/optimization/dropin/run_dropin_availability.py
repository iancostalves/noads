...
"""
Drop-in SAF: preferential energy allocation
===========================================
"""
...
# %%
# Drop-in SAF with preferential energy allocation
# -----------------------------------------------
# Same as trend, but aviation receives a preferential share (~8.6%) of global biomass
# and electricity — representing active policy support for aviation decarbonization.
