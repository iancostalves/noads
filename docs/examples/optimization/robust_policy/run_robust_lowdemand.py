...
# %%
# Robust optimization with demand avoidance
# -----------------------------------------
# Find a single policy that is feasible across SSP2-1.9, SSP2-2.6, and SSP2-3.4
# simultaneously. All propulsion architectures are available, and the optimizer can
# reduce demand as a complementary lever.
