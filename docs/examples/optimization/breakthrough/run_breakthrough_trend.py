...
"""
Breakthrough aircraft: trend resource allocation
================================================
"""
...
# %%
# Breakthrough aircraft with trend resources
# ------------------------------------------
# All propulsion architectures unlocked (H₂ gas turbine, H₂ fuel cell,
# battery-electric) plus drop-in SAF. Trend resource allocation under SSP2-2.6.
