...
class AircraftDesign(AircraftOperation):
    ...
    def __init__(
        self, name, propulsion, mission, power_system, aircraft_tech_params,
        reference_aircraft
    ):
    ...
    def _gam_design(self, input_data):
        ...
        output_data.update({
            ...
            f"{self.name}.relative_efficiency_gain":
                self.reference_aircraft.energy_per_ask / (
    ...
    def control_model(self):
        ...
        output_names = [
            f"control.{self.name}.share.times", f"control.{self.name}.share.values"
        ]
    ...
    def _control_share(self, input_data):
        ...
        control_times = array([1.0, 1.0, 1.0, 1.0]) * eis +\
